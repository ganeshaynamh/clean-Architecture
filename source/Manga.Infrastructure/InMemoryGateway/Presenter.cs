namespace Manga.Infrastructure.InMemoryGateway
{
    ...
    public sealed class Presenter : 
        ...
        Application.Boundaries.SignUpUser.IOutputHandler

    {
        ...
        public Collection<Application.Boundaries.SignUpUser.Output> SignUpUsers { get; }
        ...
        public Presenter()
        {
            ...
            SignUpUsers = new Collection<Application.Boundaries.SignUpUser.Output>();
        }
        ...
        public void Handle(Application.Boundaries.SignUpUser.Output output)
        {
            SignUpUsers.Add(output);
        }
