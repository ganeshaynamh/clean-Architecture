...
namespace Manga.Infrastructure.EntityFrameworkDataAccess.Migrations
{
    ...
    [Migration("20190706161147_InitialCreate1")]
            ...
            modelBuilder.Entity("Manga.Domain.Accounts.Credit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 400.0,
                            TransactionDate = new DateTime(2019, 7, 6, 16, 11, 46, 497, DateTimeKind.Utc).AddTicks(6874)
                        });
                });
            ...
            modelBuilder.Entity("Manga.Domain.Accounts.Debit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountId = new Guid("4c510cfe-5d61-4a46-a3d9-c4313426655f"),
                            Amount = 400.0,
                            TransactionDate = new DateTime(2019, 7, 6, 16, 11, 46, 498, DateTimeKind.Utc).AddTicks(646)
                        });
                });
